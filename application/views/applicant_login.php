	...
	<div class="d-flex flex-column flex-lg-row flex-column-fluid">
		...
		<div class="d-flex flex-lg-row-fluid">
			...
			<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
				...
				<!--end::Title-->
				<!--begin::Text-->
				<div class="text-gray-600 fs-base text-center fw-semibold">Applicants can access their respective
					portals and pay their application fees,<br> generate application token, apply for admission, print
			...
			<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
				...
				<div class="w-md-400px">
					...
					<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-redirect-url="#"
						method="POST" action="<?= base_url('admission/login') ?>">
						<!--begin::Heading-->
						...
						<div class="fv-row mb-8">
							<!--begin::Email-->
							<input id="username" type="text" placeholder="Phone Num/Application Num" name="username" autocomplete="off"
