		...
		<div class="container-fluid text-white">
			...
			<div class="row justify-content-between">
				<ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
					<li>
						<a class="nav-link active" href="<?php echo base_url(); ?>admin/exams/"><i class="icon icon-plus-circle"></i> Add Marks</a>
					</li>
					<li>
			...
			<div class="col-md-12">
				...
				<div class="card">
					<div class="card-header">
						<div class="card-title"><i class="icon icon-search"></i> <?php echo get_phrase('select_criteria'); ?>
							<div class="float-right">
								...
								<a href="<?php echo site_url('admin/exams/import') ?>" class="btn btn-primary btn-sm text-white"><i class="icon icon-upload"></i> <?php echo 'Upload Marks'; ?>
								</a>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
								<form role="form" action="<?php echo site_url('admin/exams/create') ?>" method="post">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<button type="button" id="show" name="search" value="search_filter" class="btn btn-danger btn-sm pull-right checkbox-toggle"><i class="icon icon-search"></i> <?php echo get_phrase('search'); ?></button>
											</div>
										</div>
									</div>
								</form>
