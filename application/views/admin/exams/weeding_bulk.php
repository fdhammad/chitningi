                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="col-md-12">
                            ...
                            <hr />
                            <?= form_open_multipart(base_url('admin/exams/weeding_upload_and_process'), ['id' => 'weedingimportMarksForm']) ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="submit" id="" name="weeding" class="btn btn-primary btn-sm pull-right checkbox-toggle">
