...
<page backtop="7mm" backbottom="7mm" footer="page">
    ...
    $adm_semester = $this->db->get_where('semesters', array('id' => $admission_year))->row()->semester;
        ...
        <page_header>
            ...
            <div class=" mainstudentsessionreport">
                <div class="studentsession-headers">
                    ...
                    <div class="school-name">
                        <h2 style="text-transform: uppercase;"> REGISTERED STUDENT LIST <?= $adm_session ?> ACADEMIC SESSION <?= $adm_semester ?> </h2>
