										...
										<div class="card shadow">
											<div class="card-header white">
												...
												<div class="col-md-8 float-right">
													<a href="<?php echo base_url() . "admin/students/edit/" . $student["id"] ?>" class="btn btn-xs btn-primary" data-toggle="tooltip" title="<?php echo 'Edit'; ?>"><i class="icon icon-edit"></i>
														<?php echo 'Edit';
														?>
													</a>
													<a href="#Modal" class="btn btn-xs btn-success" data-toggle="tooltip" title="<?php echo 'Login details'; ?>"><i class="icon icon-key4"></i>
														<?php echo 'Login details';
														?>
													</a>
													<?php if($student['class_id'] == "0"):?>
													<a href="<?php echo base_url() . 'admin/students/admission_pdf/'. $student["id"]; ?>" type="button" title="Generate Admission Letter" class="btn btn-xs btn-info" target="_blank"><i class="icon icon-print"></i>Print Admission Letter</a>
													<?php endif; ?>
													<form method="post">
														<input type="hidden" id="st_id" name="st_id" value="<?php echo $student['id']; ?>">

														<button class="btn btn-xs btn-danger float-right reset" type="button" title="Reset Password"><i class="icon icon-close"></i>Reset Password</button>
													</form>
												</div>
												<h4>BIO DATA</h4>
												<hr>
							...
							<div class="col-md-12">
								<div class="card no-b">
									<div class="card-header white b-0 p-3">
										...
										<small class="card-subtitle mb-2 text-muted">Payments made by Student.</small>
									</div>
												...
												<table id="recent-orders" class="table table-hover mb-0 ps-container ps-theme-default">
													...
													<tbody>
														...
														?>
															...
															?>
																<tr>
																	<td><a href="<?php echo base_url() ?>admin/payments/receipt/<?php echo $fee->receipt; ?>" target="_blank"><?php echo $fee->receipt; ?></a></td>
																	<td><a href="https://login.remita.net/remita/exapp/api/v1/send/api/print/billsvc/biller/<?php echo $fee->receipt; ?>/printrecieptRequest.pdf" target="_blank"><?php echo $fee->txn; ?></a></td>
																	<td><?php echo $fee->class; ?></td>
																	<td><?php echo $fee->session; ?></td>
																	<td><?php echo $fee->semester; ?></td>
																	<td><?php echo $fee->date; ?></td>
																	<td><?php if ($fee->status == "paid") { ?><span class="badge badge-success">Paid</span><?php } else { ?><span class="badge badge-warning"><?php echo $fee->status; ?></span><?php }; ?></td>
																	<td><?php echo $currency_symbol . ' ' . $amount; ?></td>
																	<td>
																		<?php if ($fee->status == 'paid') { ?>
																		<?php } else { ?>
																			<form action="<?php echo base_url(); ?>/admin/student/check_rrr_status/<?php echo $fee->student_id; ?>" method="POST">
																				<input id="RRR" name="RRR" value="<?php echo $fee->receipt; ?>" type="hidden">
																				<input type="submit" class="btn btn-xs btn-info" name="submit_btn" value="Status">
																			</form>
																		<?php
																	...
																	<!-- <td>
																		...
																		?>
																	<td><a type="button" href="javascript:void(0)" data-id="<?php echo $fee->receipt; ?>" class="btn btn-warning btn-xs edit-product " id="<?php echo $fee->receipt; ?>"> <i class="icon-edit"></i></a>
																	<?php
																		}; ?>

																	<a href="<?php echo site_url("admin/student/drop_pay/" . $id) ?>" class="btn btn-xs btn-danger delete" id="<?php echo $id; ?>" data-toggle=" tooltip" data-placement="top" title="" data-original-title="Delete"> <i class="icon-trash"></i></a>
