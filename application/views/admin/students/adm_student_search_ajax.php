		...
		<div class="col-12 col-xl-12">
			<div class="card shadow">
				<div class="card-header danger text-white text-uppercase text-center download_label">
					<h4><?php echo  'Registered Student Report'; ?></h4>
					...
					<div class="tab-content">
						<div class="tab-pane fade show active" id="v-pills-tab1" role="tabpanel" aria-labelledby="v-pills-tab1">
							...
							<?php if ($searchby == "filter") { ?>
							 ...
							 --><?php } ?>
							<div class="float-right"> <a href="<?php echo base_url(); ?>admin/students/getRegListOfStudentsPDF/<?php echo $course_id . '/' . $class_id ?>" class="btn btn-outline-primary btn-sm mr-3" type="button" name="generate" target="_blank" title="Generate List by Level"><i class="icon-download"></i> <?php echo 'Generate List by Level'; ?></a></div>
											...
											?>
												<tr>
													...
													<td>
														...
														<a href="<?php echo base_url() . 'admin/students/admission_pdf/'. $student["id"]; ?>" type="button" title="Admission" class="btn btn-xs btn-info" target="_blank"><i class="icon icon-print"></i>Print Admission</a>
