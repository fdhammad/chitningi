            ...
            <div class="card my-3 no-b shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="test_trans" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th><?php echo 'S/N'; ?></th>
                                    <th><?php echo 'RRR '; ?></th>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text text-right">
                                            ...
                                            <?php } else { ?>
                                                <form action="<?php echo base_url(); ?>admin/payments/check_test_status/<?php echo $feeList['student_id']; ?>" method="POST">
