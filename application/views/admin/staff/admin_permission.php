...
$modules = [
    'staff', 'applicants', 'students', 'academics', 'exams', 'payments', 'settings', 'sessions', 'semesters', 'classes', 'subjects', 'schools', 'tokens', 'courses', 'switches'
];
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo ucwords($page_title); ?>
                            <a href="<?php echo site_url('admin/staff'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"> <i class="mdi mdi-arrow-left"></i> <?php echo get_phrase('back_to_admins'); ?></a>
                        </h4>
                    </div> <!-- end card body-->
                </div> <!-- end card -->
            </div><!-- end col-->
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">
                            <?php echo get_phrase('assign_permission_for'); ?> : <?php echo $permission_assign_to['firstname'] . ' ' . $permission_assign_to['lastname']; ?>
                        </h4>
...
<script>
    ...
    function setPermission(arg) {
        ...
        $.ajax({
            url: '<?php echo site_url('admin/staff/assign_permission'); ?>',
            type: 'POST',
            data: {
                arg: arg
            },
