												...
												?>
													<tr>
														...
														<td>
															...
															<?php if (!is_root_admin($staff['id'])) : ?>
																<a href="<?php echo base_url(); ?>admin/staff/view/<?php echo $staff['id'] ?>" class="btn btn-primary btn-xs" data-toggle="tooltip" title="View Staff Details" data-original-title="View">
																	<i class="icon-eye"></i>
																</a>

																<a href="<?php echo base_url(); ?>admin/staff/edit/<?php echo $staff['id'] ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" title="Edit Staff" data-original-title="Edit Staff">
																	<i class="icon-pencil"></i>
																</a>


																<button type="submit" class="btn btn-danger btn-xs delete" id="<?php echo $staff['id']; ?>"> <i class="icon-trash"></i></button>
																<a class="btn btn-info btn-xs" href="<?php echo site_url('admin/staff/permissions?permission_assing_to=' . $staff['id']) ?>" data-toggle="tooltip" title="Assign Permission" data-original-title="Assign Permission"><i class="icon-arrow-up"></i></a>
															<?php else : ?>
