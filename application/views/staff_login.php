	...
	<div class="d-flex flex-column flex-lg-row flex-column-fluid">
		...
		<div class="d-flex flex-lg-row-fluid">
			...
			<div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
				...
				<!--end::Title-->
				<!--begin::Text-->
				<div class="text-gray-600 fs-base text-center fw-semibold"><h4>Staff Login</h4>
				</div>
				<!--end::Text-->
				<!--end::Text-->
			</div>
		...
		<div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12">
			...
			<div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
				...
				<div class="w-md-400px">
					<!--begin::Form-->
					<form class="form w-100" novalidate="novalidate" id="kt_staff_sign_in_form" data-redirect-url="#" method="POST" action="<?= base_url('staff/login') ?>">
						<!--begin::Heading-->
						...
						<div id='staff_err_msg' style='display: none'>
							<div id='content_result'>
								<div id='staff_err_show' class="w3-text-red">
									<div id='staff_msg' class='alert alert-danger'> </div></label>
								</div>
							</div>
						</div>
						<!--begin::Separator-->
						...
						<div class="fv-row mb-8">
							<!--begin::Email-->
							<input id="email" type="email" placeholder="Email Address" name="email" autocomplete="off" class="form-control bg-transparent" required />
							<!--end::Email-->
						</div>
						<!--end::Input group=-->
						...
						<div class="d-grid mb-10">
							<button type="submit" id="staff_submit" class="btn btn-primary">
