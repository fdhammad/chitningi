													...
													<table class="table table-hover table-condensed" id="users">
														...
														<tbody>
															...
															foreach ($deposit as $value) {;
																...
																<tr>
																	<?php if ($value['status'] == 'paid') {; ?> <td> <a href="#"><?php echo $a; ?></a></td>
																	<?php } else {; ?>
																		<td> <a href="#"><?php echo $a; ?></a></td>
																	<?php } ?>
																	<td><?php echo $value['txn']; ?></td>
																	<td>Online Application Fee</td>
																	<td><?php echo $value['amount']; ?></td>
																	<td><?php if($value['amount'] !=NULL): echo 322.50; endif ?></td>
																	...
																	<td><?php if ($value['status'] == 'paid') {; ?>
																			<a href="<?= base_url('applicant/receipt/' . $value['receipt']) ?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-download"></i> Print Receipt</a>
																		<?php } else { ?>

																			<form action="<?php echo base_url(); ?>applicant/check/<?php echo $value['receipt']; ?>" method="POST">
