											...
											<tbody>
												...
												<tr>
													...
													<td>&#8358;<span class="money"><strong>
																<?php echo number_format($amount+322.50); ?>
															</strong></span></td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td>
														<div class="row mt-4">
															<div class="col-3"> <a class="btn btn-primary"
																	href="<?php echo base_url('applicant/payment/'); ?>"
																	role="button"><i
																		class="fa fa fa-cross"></i>Cancel</a>



															</div>
															<div class="col-3">
																<form action="<?php echo $GATEWAYRRRPAYMENTURL; ?>"
																	method="POST">
																	<input id="merchantId" name="merchantId"
																		value="<?php echo $merchantId; ?>"
																		type="hidden">
																	<input id="hash" name="hash"
																		value="<?php echo $hash; ?>" type="hidden">
																	<input id="rrr" name="rrr"
																		value="<?php echo $rrr; ?>" type="hidden">
																	<input id="responseurl" name="responseurl"
																		value="<?php echo $responseurl; ?>"
																		type="hidden">
																	<input type="submit"
																		class="btn btn-success float-center"
																		name="submit_btn" value="Submit">
