													...
													<table class="table">
														<tbody>
															...
															<tr>
																...
																<td>
																	<div class="form-group col-8 m-0">
																		<select id="program" name="program" aria-label="Select a programme" data-control="select2" data-placeholder="Select a programme..." class="form-select form-select-solid form-select-lg fw-semibold" required>
																			<option value=""></option>
															...
															<tr>
																...
																<td>
																	<div class="fw-bold text-primary pt-2" style="font-size: 24px ;"><span id="amount" class="amount">--</span></div>
																</td>
															</tr>
															<tr>
																<td class=""></td>
