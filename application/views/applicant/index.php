...
$user_details = $this->applicant_model->get_all_applicant($this->session->userdata('user_id'))->row_array();
						...
						<div class="app-navbar flex-shrink-0">
							...
							<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
								...
								<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
									<img src="<?php echo $this->user_model->get_user_image_url($this->session->userdata('user_id')); ?>" alt="user" />
								</div>
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="symbol symbol-50px me-5">
												<img alt="Logo" src="<?php echo $this->user_model->get_user_image_url($this->session->userdata('user_id')); ?>" />
											</div>
											<!--end::Avatar-->
											<?php
											$logged_in_user_details = $this->applicant_model->get_all_applicant($this->session->userdata('user_id'))->row_array();
											?>
											<!--begin::Username-->
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5"><?php echo $logged_in_user_details['firstname'] . ' ' . $logged_in_user_details['lastname']; ?>
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?= 'Applicant' ?></span>
												</div>
									...
									<div class="menu-item px-5">
										<a href="<?php echo base_url(); ?>admission/logout" class="menu-link px-5">Sign Out</a>
									</div>
									<!--end::Menu item-->
								</div>
