        ...
        <div class="studentsession-contents studentsessionreporttable">
            ...
            <div class="class">
                <p style="font-size: 14px; line-height: 25px;">
                    I am pleased to inform you that you have been offered provisional Admission to pursue <?= $year; ?> (<?= $student['year'] ?>) years academic programs leading to the award of <b><?= $student['course']; ?> (<?= $student['code']; ?>)</b> with effect from <b><?= $adm_session; ?></b> Academic Session.
                </p>
                ...
                <ol type="a">
                    ...
                    <li style="font-size: 14px; line-height: 25px;">That you produce evidence of sponsorship from your employer before you are registered (In Service).</li>
                </ol>
                <br>
                <b style="font-size: 14px; line-height: 25px;">N.B: Students indexing fees are not included in the attached registration charges, however students will be asked to make such payment after receiving instructions from their respective regulatory bodies.</b>
            </div>
            <div style="padding-top:20px; text-align:right">
                <img src="<?php echo base_url('uploads/sign/sign.jpg'); ?>" alt="Signature" width="100" height="50" style="display: block; margin-bottom: 5px;">
                <p style="font-size: 14px; line-height: 20px;"><b>Musa Bako Ningi</b></p>
                <p style="font-size: 14px; line-height: 20px;"><b>Registrar</b></p>
            </div>
        </div>
        <!-- 	<div class="diidol">
			Powered By Diidol
