	...
	<body>
		...
		<div class="studentsession-contents studentsessionreporttable">
			<table width="928">
				<tbody>
					<tr>
						<th id="semester" colspan="5" style="font-size: 18px; text-transform: uppercase;">SEMESTER: <?php echo $semester['semester']; ?></th>

						<td id="session" colspan="2" style="font-size: 18px; text-transform: uppercase;"><strong> SESSION: <?php echo $session['session']; ?></strong></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><span class="contents"><strong><?php echo $student['phone']; ?></strong></span></td>
					</tr>
					<tr>
						<th>Full-Name</th>
					...
					<!-- <tr>
						<th>Programme</th>
						<td width="235"><span class="contents"><b><?php echo $student['program']; ?></b></span></td>
						<td colspan="2" width="111" valign="top"> School</td>
						<td width="166" valign="top"><strong><span class="contents"><?php echo $student['sch_code']; ?></span></strong></td>
					</tr> -->
					<tr>
						<th>Course</th>
					...
					<tr>
						<th>Gender</th>
						<td><strong><?php echo $student['gender']; ?>
							</strong></td>
					...
					if (customCompute($registered)) {
						foreach ($registered as $reg) {	?>
							<tr>
								...
								<td><?= $reg->code ?></td>
								<td><?= $reg->subject ?></td>
								<td style="text-align: center;"><?= $reg->status ?></td>
				...
				<tbody>
					<tr>
						...
						<td id="sign"><br /><br />
							...
							....................................................................................................<br />
							SIGN OF THE DEAN (EDUCATION) AND DATE
					...
					<tr>
						<td id="sign"><br /><br />
							...
							...................................................................................................<br />
							SIGNATURE OF HOD AND DATE

						</td>
						<td id="sign"><br /><br />

							....................................................................................................<br />
							SIGN OF THE DEAN (SCHOOL) AND DATE
					...
					<tr>
						...
						<td id="sign"><br /><br />
							...
							....................................................................................................<br />
							SIGNATURE OF ACADEMIC SECRETARY AND DATE
			...
			<div class="note">
				<span class="style25"><b>NOTE:</b> You are given two weeks after commencement of Registration to return the duly completed Semester Registration Form to Academic Office.
					You may be subcharge for late submission. Make a copy to yourself; a copy to your School and Dean of Education; also a copy each to your H.O.D(s), and then submit the original copy to the Academic Office.
				</span>
			</div>
