									...
									<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed rounded-3 p-6">
										...
										<div class="d-flex flex-stack flex-grow-1">
											...
											<div class="fw-semibold">
												...
												<div class="fs-6 text-gray-700">Its appears that you have not pay your fees, click on pay now to process
													<?php if ($student['class_id'] == 0) { ?>
														<a href="<?= base_url('student/pre_payment') ?>" class="fw-bold">Pay now</a>
													<?php } elseif ($student['class_id'] == 1 && $check_admission_payment != true) { ?>
													...
													<?php } elseif ($student['class_id'] == 2 && $student['course_id'] == 20 && $check_admission_payment != true) { ?>
														<a href="<?= base_url('student/admission_payment') ?>" class="fw-bold">Pay now</a>
													<?php } else { ?>
														<a href="<?= base_url('student/payment') ?>" class="fw-bold">Pay now</a>
													<?php } ?>
							...
							<div class="card-body pt-0 fs-6">
								...
								<div class="mb-10">
									...
									<div class="mb-0">
										...
										<div class="fw-semibold text-gray-600 d-flex align-items-center">Registration Fee
								...
								<div class="mb-0">
									...
									<?php } else { ?>
										...
										<?php } elseif ($student['class_id'] == 2 && $student['course_id'] == 20 && $check_admission_payment != true) { ?>
											<a href="<?= base_url('student/admission_payment') ?>" class="btn btn-primary er fs-6 px-8 py-4">Pay now</a>
										<?php } else { ?>
											<a href="<?= base_url('student/payment') ?>" class="btn btn-primary er fs-6 px-8 py-4">Pay now</a>
										<?php } ?>
									<?php } ?>
