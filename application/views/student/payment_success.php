										...
										<table class="table">
											<tbody>
												...
												<tr>
													<td>Status</td>
													<td>
														<span class="badge badge-success text-capitalize p-3"><?php echo $status ?></span>
												...
												<tr>
													<td>RRR</td>
													<td><b style="font-size: 20px;"><?php echo $RRR; ?> </b></td>
												</tr>
														...
														<div class="row mt-4">
															<div class="col-3">
																<?php if ($student['class'] == '0') { ?>
																	<a class="btn btn-light-info" href="<?php echo base_url('student/dashboard/'); ?>" role="button"><i class="fa fa fa-cross"></i>Goto Dashboard</a>
