										...
										<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed rounded-3 p-6">
											...
											<div class="d-flex flex-stack flex-grow-1">
												...
												<div class="fw-semibold">
													...
													<div class="fs-6 text-gray-700">Confirm your details below before
														proceeding.
									...
									<div class="card-body pt-0 fs-6">
										...
										<div class="mb-7">
											...
											<div class="mb-0">
												...
												<!--begin::Plan-->
												<form id="general-info" action="<?= base_url('student/init_pay') ?>" method="POST" class="form-validation needs-validation" novalidate="novalidate" accept-charset="utf-8" enctype="multipart/form-data">
													<?php echo $this->customlib->getCSRF(); ?>
														...
														<tbody>
															<tr>
																...
																<td><span class="text-uppercase">
																		<?php echo $student['firstname'] . ' ' . $student['lastname'] . ' ' . $student['middlename']; ?>
																	</span></td>
															</tr>
															<tr>
																<td>Course </td>
																<td><span class="text-capitalize">
																		<?php echo $student['course'] . " (" . $student['code'] . ")"; ?>
																	</span></td>
															</tr>
															...
															<tr>
																<td>Payment Descr </td>
																<td>
																	<?php echo "Semester Registration Fee"; ?>
																</td>
															</tr>
															...
															<tr>
																<td><label class="fs-6 fw-semibold form-label">Amount
																		you are Pay is:</label>
																</td>
																<td>
																	<div class="fw-bold text-primary pt-2" style="font-size: 24px ;"><span id="amount" class="amount">₦
															...
															<tr>
																...
																<td class="">
																	<div class="row mt-4">
																		<div class="col-3"> <a class="btn btn-primary" href="<?php echo base_url('students/payment/'); ?>" role="button"><i class="fa fa fa-cross"></i>Cancel</a>
															...
															<tr>
																...
																<td colspan="" class=""><img src="<?= base_url('assets/img/remita.png') ?>" height="50px" width="200px">
																</td>
														</tbody>
													</table>
												</form>
