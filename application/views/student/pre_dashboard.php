									...
									<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed rounded-3 p-6">
										...
										<div class="d-flex flex-stack flex-grow-1">
											...
											<div class="fw-semibold">
												...
												<div class="fs-6 text-gray-700">Its appears that you have not pay your Weeding Registration fee, click on pay now to process

													<a href="<?= base_url('student/pre_payment') ?>" class="fw-bold">Pay now</a>
							...
							<div class="card-body pt-0 fs-6">
								...
								<div class="mb-10">
									...
									<div class="mb-0">
										...
										<div class="fw-semibold text-gray-600 d-flex align-items-center">Weeding Registration Fee
								...
								<div class="mb-0">
								    <?php if ( $check_admission_payment == true) { ?>
										<div class="mb-0">
										    	<a href="<?= base_url('student/pre_payment') ?>" class="btn btn-primary er fs-6 px-8 py-4">Pay now</a>
										    	
											<a href="<?php echo base_url() . 'student/admission_pdf/'; ?>" type="button" title="Generate Admission Letter" class="btn btn btn-success er fs-6 px-8 py-4" target="_blank"><i class="fa fa-print"></i>Print Admission Letter</a>
										</div>
									
									<?php }elseif ($check_pre_payment == true) { ?>
									<div class="mb-0">
