				...
				<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
					...
					<div class="col-xl-7">
						...
						<div class="card card-flush pt-3 mb-0">
							<!--begin::Card header-->
							<?php if ($check_post_payment != true) { ?>
								<div class="row">
									<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed rounded-3 p-6">
										...
										<div class="d-flex flex-stack flex-grow-1">
											...
											<div class="fw-semibold">
												...
												<div class="fs-6 text-gray-700">Its appears that you have not pay your Post-Weeding Registration fee, click on pay now to process

													<a href="<?= base_url('student/post_payment') ?>" class="fw-bold">Pay now</a>
							...
							<div class="card-body pt-0 fs-6">
								...
								<div class="mb-10">
									...
									<div class="mb-0">
										...
										<div class="fw-semibold text-gray-600 d-flex align-items-center">Post Weeding Registration Fee
								...
								<div class="mb-0">
									...
									<?php } else { ?>
										<a href="<?= base_url('student/post_payment') ?>" class="btn btn-primary er fs-6 px-8 py-4">Pay now</a>
