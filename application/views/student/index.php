...
$user_details = $this->student_model->get_all_student($this->session->userdata('user_id'))->row_array();
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
					...
					<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
						...
						<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="{default: 'append', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_wrapper'}">
							<!--begin::Menu-->
							<div class="fs-6 fw-bold text-gray-800 mt-8 text-center">
								<h2 class="text-center text-primary"><?= current_semester_name() ?> / <?= current_session_name() ?></h2>
							</div>
						...
						<div class="app-navbar flex-shrink-0">
							...
							<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
								...
								<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
									<img src="<?php echo $this->student_model->get_user_image_url($this->session->userdata('user_id')); ?>" alt="user" />
								</div>
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="symbol symbol-50px me-5">
												<img alt="Logo" src="<?php echo $this->student_model->get_user_image_url($this->session->userdata('user_id')); ?>" />
											</div>
											<!--end::Avatar-->
											<?php
											$logged_in_user_details = $this->student_model->get_all_student($this->session->userdata('user_id'))->row_array();
											?>
											<!--begin::Username-->
											<div class="d-flex flex-column">
												<div class="fw-bold d-flex align-items-center fs-5"><?php echo $logged_in_user_details['firstname'] . ' ' . $logged_in_user_details['lastname']; ?>
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2"><?= 'student' ?></span>
												</div>
												<a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?= $logged_in_user_details['phone'] ?></a>
											</div>
											<!--end::Username-->
										</div>
									</div>
