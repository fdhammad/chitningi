									...
									<div class="card-body pt-0 fs-6">
										...
										<div class="mb-7">
											...
											<div class="mb-0">
												...
												<!--begin::Plan-->
												<form id="general-info" action="<?= base_url('student/init_admission_pay_direct') ?>" method="POST" class="form-validation needs-validation" novalidate="novalidate" accept-charset="utf-8" enctype="multipart/form-data">
													<?php echo $this->customlib->getCSRF(); ?>
													...
													<table class="table">
														<tbody>
															...
															<tr>
																<td>Payment Descr </td>
																<td><?php echo "Admission Access Fee"; ?></td>
															</tr>
															...
															<tr>
																...
																<td class="">
																	<div class="row mt-4">
																		<div class="col-3"> <a class="btn btn-primary" href="<?php echo base_url('students/admission_payment/'); ?>" role="button"><i class="fa fa fa-cross"></i>Cancel</a>
