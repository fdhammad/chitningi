													...
													<tbody>
														...
														?>
															<tr>
																...
																<td><a href="<?php echo base_url() ?>admin/student/invoice/<?php echo $feeList->receipt; ?>"><?php echo $a; ?></a></td>
																<td>
																...
																<?php if ($feeList->status != 'paid') { ?>
																	...
																	<td>
																		<form action="<?php echo base_url(); ?>admin/payments/check_status2/<?php echo $feeList->student_id; ?>" method="POST">
