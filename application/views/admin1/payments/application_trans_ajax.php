	...
	<div class="row my-3">
		<div class="col-md-12">
			<div class="card my-3 no-b shadow">
				<H4 class="card-header"><B>Application Transactions History</B></H4>
				<div class="card-body">
							...
							?>
								<tr>
									...
									<td class="text text-right">
										...
										<?php } else { ?>
											<form action="<?php echo base_url(); ?>admin/payments/check_application_status/<?php echo $feeList['applicant_id']; ?>" method="POST">
