		...
		<div class="container-fluid text-white">
			...
			<div class="row justify-content-between">
				<ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
					<li>
						<a class="nav-link active" id="v-pills-all-tab" data-toggle="pill" href="#v-pills-all" role="tab" aria-controls="v-pills-all"><i class="icon icon-home2"></i>Search Students</a>
					</li>
									...
									<div class="row">
										<div class="col-md-12">
											<div id="searchDiv" class="form-group">
												<button type="button" id="show" value="search_filter" class="btn btn-primary pull-right"><i class="icon icon-search"></i> <?php echo get_phrase('search'); ?></button>
											</div>
										</div>
									</div>
								</form>
