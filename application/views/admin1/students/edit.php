		...
		<div class="container-fluid text-white">
			...
			<div class="row justify-content-between">
				<ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
					<li>
						<a class="nav-link" href="<?php echo base_url("admin/students/view/" . $id); ?>"><i class=" icon icon-home2"></i> Student Profile</a>
					</li>
					<li>
						<a class="nav-link active" href="<?php echo base_url("admin/students/edit/" . $id); ?>"><i class=" icon icon-edit"></i> Edit Student</a>
					</li>
					<li>
									...
									<div class="col-md-8">
										...
										<div class="form-group m-0">
											...
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" id="male" name="gender" class="custom-control-input" <?php if ($student['gender'] == "M" || $student['gender'] == "Male") echo "checked"; ?> value="Male">
												<label class="custom-control-label m-0" for="male">Male</label>
											</div>
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" id="female" name="gender" class="custom-control-input" <?php if ($student['gender'] == "F" || $student['gender'] == "Female") echo "checked"; ?> value="Female">
