	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<?php if (has_permission('applicants')) : ?>
				<li class="treeview <?php if ($page_name == 'applicants')
										echo 'active';
									?>">
					<a href=" #">
					...
					<ul class="treeview-menu">
						...
						<li class="<?php if ($page_name == 'applicants') echo 'active'; ?>">
							<a class="<?php if ($page_name == 'applicants') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/applicants"><i class="icon icon-circle-o"></i>Search Applicants</a>
						</li>
			...
			<?php endif; ?>
			<li class="treeview <?php if ($page_name == 'students/create' || $page_name == 'students/list') : ?> active <?php endif; ?> ">
				<a href="#">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php if ($page_name == 'students/search') echo 'active'; ?>">
						<a href="<?php echo base_url(); ?>admin/students/search"><i class="icon icon-circle-o"></i>Search Students</a>
					</li>

					<li class="<?php if ($page_name == 'students/create') echo 'active'; ?>">
						<a href="<?php echo base_url(); ?>admin/students/create"><i class="icon icon-add"></i>Add Student</a>
					</li>
			...
			<li class="treeview" <?php if ($page_name == 'payments/application_trans') echo 'active'; ?>><a href="<?php echo base_url(); ?>admin/payments/application_trans">
			...
			<li class="treeview <?php if ($page_name == 'payments/report') echo 'active'; ?>">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php if ($page_name == 'payments/search') echo 'active'; ?>">
						<a href="<?php echo base_url(); ?>admin/payments/search"><i class="icon icon-circle-o"></i>Search</a>
					</li>
			...
			<li class="treeview <?php if ($page_name == 'schools' || $page_name == 'departments' || $page_name == 'classes' || $page_name == 'courses' || $page_name == 'subjects') : ?> active <?php endif; ?>">
				<a href="#">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php if ($page_name == 'schools') echo 'active'; ?>">
						<a class="<?php if ($page_name == 'schools') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/schools"><i class="icon icon-circle-o"></i>Schools</a>
					</li>

					<li class="<?php if ($page_name == 'departments') echo 'active'; ?>">
						<a class="<?php if ($page_name == 'departments') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/departments"><i class="icon icon-circle-o"></i>Departments</a>
					</li>

					<li class="<?php if ($page_name == 'classes') echo 'active'; ?>">
						<a class="<?php if ($page_name == 'classes') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/classes"><i class="icon icon-circle-o"></i>Levels</a>
					</li>

					<li class="<?php if ($page_name == 'courses') echo 'active'; ?>">
						<a class="<?php if ($page_name == 'courses') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/courses"><i class="icon icon-circle-o"></i>Programmes</a>
					</li>

					<li class="<?php if ($page_name == 'applicants') echo 'active'; ?>">
						<a class="<?php if ($page_name == 'departments') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/sug"><i class="icon icon-circle-o"></i>Assign Lecturer</a>
					</li>

					<li class="<?php if ($page_name == 'applicants') echo 'active'; ?>">
						<a class="<?php if ($page_name == 'departments') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/registrable_courses"><i class="icon icon-circle-o"></i>Registrable Courses</a>
					</li>
					<li class="<?php if ($page_name == 'subjects') echo 'active'; ?>">
						<a class="<?php if ($page_name == 'subjects') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/subjects"><i class="icon icon-circle-o"></i>Courses</a>
					</li>
			...
			?>
					...
					<li class="treeview <?php if ($page_name == 'settings' || $page_name == 'sessions' || $page_name == 'semesters') : ?> active <?php endif; ?>">
						...
						<ul class="treeview-menu ">
							...
							<li class="<?php if ($page_name == 'settings') echo 'active'; ?>">
								<a class="<?php if ($page_name == 'settings') echo 'text-primary'; ?>" href="<?php echo base_url(); ?>admin/settings"><i class="icon icon-circle-o"></i>Settings</a>
							</li>
							<li class="">
