...
class Departments extends CI_Controller
{
	...
	function index()
	{
		...
		$page_data['page_title'] = site_phrase('departments');
	...
	function get_by_id()
	{
		...
		$data = $this->department_model->get_by_id($id);
	...
	public function update()
	{
		...
		$modal_department = $this->input->post('modal_name');
		...
		if ($modal_department) {
			$update = $this->department_model->add($data);
			$status = true;
		}
		$data = $this->department_model->get_by_id($modal_id);
