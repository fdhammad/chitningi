...
if (!function_exists('current_session')) {
	function current_session($key = 'session')
	{
		$CI    = &get_instance();
		$CI->load->database();
...
if (!function_exists('current_session_name')) {
	function current_session_name($key = 'session')
	{
		$CI    = &get_instance();
		$CI->load->database();

		$CI->db->where('key', $key);
		$id = $CI->db->get('settings')->row('value');

		$CI->db->where('id', $id);
		$result = $CI->db->get('sessions')->row('session');
		return $result;
	}
}
if (!function_exists('current_semester')) {
	function current_semester($key = 'semester')
	{
		$CI    = &get_instance();
		$CI->load->database();
...
if (!function_exists('current_semester_name')) {
	function current_semester_name($key = 'semester')
	{
		$CI    = &get_instance();
		$CI->load->database();
		...
		$CI->db->where('id', $id);
		$result = $CI->db->get('semesters')->row('semester');
		return $result;
	}
}
if (!function_exists('current_adm_session')) {
	function current_adm_session($key = 'admission_session')
	{
		$CI    = &get_instance();
		$CI->load->database();
...
if (!function_exists('current_adm_session_name')) {
	function current_adm_session_name($key = 'admission_session')
	{
		$CI    = &get_instance();
		$CI->load->database();
