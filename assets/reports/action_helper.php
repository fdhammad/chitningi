...
function reportheader($setting, $pdf = false)
{
	...
	if (customCompute($setting)) {
		...
		if ($pdf) {
			$data .= '<span class="header"><img class="logo" src="' . base_url('assets/img/logo/logo_bg.png') . '"></span>';
		} else {
			$data .= '<span class="header" id="headerImage"><p class="bannerLogo"><img src="' . base_url('assets/img/logo/logo_bg.png') . '"></p></span>';
		}
		$data .= '<p class="title">' . $setting[0]['name'] . '</p>';
		$data .= '<p class="title-desc">' . $setting[0]['address'] . '</p>';
		//$data .= '<p class="title-desc"> Academic Session ' . ' : 2020/2021</p>';
		$data .= '</div>';
	}
	return $data;
}
...
function reportfooter($setting, $pdf = false)
{
	...
	if (customCompute($setting)) {
		...
		$data .= '<img class="flogo" style="width:30px" src="' . base_url("assets/img/logo/logo_bg.png") . '">';
		$data .= '<p class="copyright">Copyright @' . date('Y') . " " . $setting[0]['name'] . '</p>';
		$data .= '</div>';
	}
	return $data;
}
